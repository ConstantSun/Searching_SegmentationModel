...
dest_img_path =  "/data.local/all/hangd/dynamic_data/n_135/imgs"
dest_mask_path = "/data.local/all/hangd/dynamic_data/n_135/masks"

count = 0
num_first_trial_files = len(glob.glob(img_path))//32+50
